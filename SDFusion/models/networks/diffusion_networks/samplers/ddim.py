...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
        ...
        intermediates = {'x_inter': [img], 'pred_x0': [img], 'timesteps': [total_steps]}
        ...
        for i, step in enumerate(iterator):
            ...
            # print(f'Current timestep is {index}')
            if index % log_every_t == 0 or index == total_steps - 1:
                intermediates['x_inter'].append(img)
                intermediates['pred_x0'].append(pred_x0)
                intermediates['timesteps'].append(index)
    ...
    def p_sample_ddim(self, x, c, t, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
        ...
        ##! For naive testing
        # print(f'Current timestep is {t[0]}')
        ## TODO: change hard code t condition to a more general way
        # if t[0] < 50 and t[0] > 50:
        # if t[0] < 700 and t[0] > 500:
        #     pred_x0_sdf = self.model.vqvae_module.decode_no_quant(pred_x0)
        #     ## (or) pred_x0_sdf = self.model.vqvae_module.decode(pred_x0)

        #     pred_x0_sdf = self.planner.plan(pred_x0_sdf, t)

        #     pred_x0 = self.model.vqvae_module.encode_no_quant(pred_x0_sdf)
        #     ## (or) pred_x0 = self.model.vqvae_module.encode(pred_x0_sdf)
