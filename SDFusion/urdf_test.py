...
def main():
    ...
    art_obj: sapien.Articulation = loader.load("/raid/haoran/Project/SDFusion/19898/mobility_relabel_gapartnet_wo.urdf")
...
# /raid/haoran/Project/data/part_sdf/slider_drawer/slider_drawer_19898_2_sdf_res_64.h5