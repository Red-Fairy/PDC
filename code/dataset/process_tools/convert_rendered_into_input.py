...
def sample_and_save(filename, data_path, save_path, num_points, visualize=False):
    ...
    ply_save_path = pjoin(save_path, 'ply')
    os.makedirs(ply_save_path, exist_ok=True)

    if os.path.exists(pjoin(pth_save_path, filename + '.pth')):
        return 0
    ...
    if visualize:
        ...
        o3d.io.write_point_cloud(pjoin(ply_save_path, filename + '.ply'), pcd)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default='/raid/haoran/Project/PartDiffusion/PartDiffusion/dataset/remove_path_render', help='Specify the path to the rendered data')
    parser.add_argument('--save_path', type=str, default='/raid/haoran/Project/PartDiffusion/PartDiffusion/dataset/remove_path_render', help='Specify the path to save the sampled data')
